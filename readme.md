...
5. 陰平接陽平時發生變調。首字讀若穗音陰去，次字則爲陰平，如「蕃薯」則讀作`faan3 sy1 /fan33 ʃy55*/`（亦可連續陰平）。
6. 亦有不少陽平字白讀爲陰平，如「錢」`cin1 /tʃin53/`「鎚」`ceoy1 /tʃʰɵy55/`「切」`cit1 /tʃʰit5/`「丸」`jyn1 /jyn53/`「窗簾」`coeng1 lim1 /tʃʰœŋ53 lim53/`等。
